...
GetArtistTopTracks GetArtistTopTracksFromJson(String str) =>
    GetArtistTopTracks.fromJson(json.decode(str));

String GetArtistTopTracksToJson(GetArtistTopTracks data) =>
...
class GetArtistTopTracks {
  ...
  factory GetArtistTopTracks.fromJson(Map<String, dynamic> json) =>
      GetArtistTopTracks(
